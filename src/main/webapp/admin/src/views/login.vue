  ...
  <div>
    <div class="container">
      ...
      <div class="register-container">
        <a href="#">
                              <div @click="register('yonghu')">注册用户</div>
                                                                                                                                                                                                                                                        </a>
      </div>
    </div>
  </div>
