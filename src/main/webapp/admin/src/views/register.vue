  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                        ...
                                                                        if((!this.ruleForm.zhanghao) && `gongyingshang` == this.tableName){
        ...
        return
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        if(`gongyingshang` == this.tableName && this.ruleForm.money&&(!this.$validate.isNumber(this.ruleForm.money))){
        this.$message.error(`余额应输入数字`);
        return
      }
                                                                                                                                                                              this.$http({
