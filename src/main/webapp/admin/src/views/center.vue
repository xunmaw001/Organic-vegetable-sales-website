        ...
        <el-form-item  v-if="flag=='yonghu'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji" 
              placeholder="手机" clearable></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item  v-if="flag=='gongyingshang'"  label="账号" prop="zhanghao">
          <el-input v-model="ruleForm.zhanghao" 
              placeholder="账号" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item  v-if="flag=='gongyingshang'"  label="密码" prop="mima">
          <el-input v-model="ruleForm.mima" 
              placeholder="密码" clearable></el-input>
        </el-form-item>
      </el-col>
        ...
        <el-form-item  v-if="flag=='gongyingshang'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua" 
              placeholder="联系电话" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="flag=='gongyingshang'"  label="公司地址" prop="gongsidizhi">
          <el-input v-model="ruleForm.gongsidizhi" 
              placeholder="公司地址" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
        ...
        return
                                                                        ...
                                                                        if((!this.ruleForm.zhanghao)&& 'gongyingshang'==this.flag){
        ...
        return
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        if( 'gongyingshang' ==this.flag && this.ruleForm.money&&(!isNumber(this.ruleForm.money))){
        this.$message.error(`余额应输入数字`);
        return
      }
                                                                                                                                                                              this.$http({
